  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch(import.meta.env.VITE_AI_IMAGES_LINK, {
          method: "POST",
          headers: {
    ...
    <section className="max-w-7xl mx-auto">
      <div className="">
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Create imaginative an visually stunning images generated by DALL-E AI
